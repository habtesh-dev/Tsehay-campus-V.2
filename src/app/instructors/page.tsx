    ...
    <div className="min-h-screen bg-slate-50 dark:bg-transparent flex flex-col font-sans">
      <header className="bg-white dark:bg-[#111111] border-b border-slate-200 dark:border-white/10 py-6">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-black text-slate-900 dark:text-white">Our Instructors</h1>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-12">
        <div className="bg-white dark:bg-[#111111] p-8 md:p-12 rounded-3xl border border-slate-100 dark:border-white/10 shadow-xl shadow-slate-200/50">
          ...
          <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Our Instructors</h2>
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
            Meet the expert instructors teaching at Tsehay Campus.
          </p>
          
          <div className="prose prose-slate max-w-none">
            <p>This page is currently being updated. Please check back soon for the full our instructors.</p>
