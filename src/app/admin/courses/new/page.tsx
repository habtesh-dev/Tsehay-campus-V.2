  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-20">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white">Create New Course</h1>
          <p className="text-slate-500 dark:text-slate-400">Complete all sections to publish a comprehensive course.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="pt-8 flex justify-end gap-4 border-t border-slate-200 dark:border-white/10 sticky bottom-4 bg-slate-50 dark:bg-[#0a0a0a] p-4 rounded-xl shadow-lg border">
          ...
          >
            {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Save Full Course"}
          </Button>
        </div>
